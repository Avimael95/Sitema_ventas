                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                  ...
                                  <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        ...
                                        <barcode :value="codigo" :options="{format: 'EAN-13',  height: 25}">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" v-model="nombre" class="form-control" placeholder="Descripcion del Artículo">
                                     </div>
                                </div>
                                
                                <div v-show="errorArticulo" class="form-group row div-error">
                                   <div class="text-center text-error">
                                       <div v-for="error in errorMostraMsjArticulo" :key="error" v-text="error">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==1" class="btn btn-success" @click="registrarArticulo()">Guardar</button>
   ...
   export default {
       ...
       methods: {
           listarArticulo(page,buscar,criterio){
               let me = this;
               //creo la url con el metodo get y conteneno con el parametro
           ...
           registrarArticulo(){
              // Ejecutamos el metodo de validad categoria 
               if (this.validarArticulo()) {
                   return;
               }
               //Se utiliza para hacer referencia al mismo archivo
               let me = this;
           ...
           validarArticulo(){
               ...
               this.errorMostraMsjArticulo=[];
               if (this.idcategoria==0) {
                   this.errorMostraMsjArticulo.push('Selecione un categoria');
               }
               if (!this.codigo) {
                   this.errorMostraMsjArticulo.push('El campo codigo no puede estar vacio');
               }
               if (!this.nombre) {
                   this.errorMostraMsjArticulo.push('El campo nombre no puede estar vacio');
               }
               if (!this.precio_venta) {
                   this.errorMostraMsjArticulo.push('El campo precio no puede esara  vacio');
               }
                if (!this.stock) {
                   this.errorMostraMsjArticulo.push('El campo Stock no puede esara  vacio');
               }
               if (this.errorMostraMsjArticulo.length) {
